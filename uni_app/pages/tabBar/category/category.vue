	...
	export default {
		data() {
			return {
				...
				//分类列表
				categoryList:[
					{id:1,title:'宠物大全',banner:'/static/img/category/banner.jpg',list:[
						{name:'宠物',	img:'1.jpg'},
						{name:'宠物',	img:'2.jpg'},
						{name:'宠物',	img:'3.jpg'},
						{name:'宠物',	img:'4.jpg'},
					...
					{id:2,title:'宠物服饰',banner:'/static/img/category/banner.jpg',list:[
						{name:'服饰',	img:'6.jpg'},
						{name:'服饰',	img:'7.jpg'},
						{name:'服饰',	img:'8.jpg'},
						{name:'服饰',	img:'9.jpg'},
					]},
					{id:3,title:'宠物食物',banner:'/static/img/category/banner.jpg',list:[
						{name:'主粮',	img:'31.jpg'},
						{name:'零食',	img:'32.jpg'},
					]},
					{id:4,title:'宠物玩具',banner:'/static/img/category/banner.jpg',list:[
						{name:'玩具',	img:'42.jpg'},
						{name:'玩具',img:'43.jpg'},
						{name:'玩具',	img:'41.jpg'},
					]},
					{id:5,title:'宠物日用',banner:'/static/img/category/banner.jpg',list:[
						{name:'日用',	img:'51.jpg'},
						{name:'日用',	img:'52.jpg'},
					]},
					{id:6,title:'宠物窝',banner:'/static/img/category/banner.jpg',list:[
						{name:'宠物窝',	img:'61.jpg'},
						{name:'宠物窝',	img:'62.jpg'},
					]},
				]
